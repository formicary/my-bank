...
//        this.accounts = new ArrayList<com.abc.Account>();
//    }
    ...
    public void openAccount(Account account) {
        ...
        System.out.println("com.abc.Account has been added to the com.abc.Customer's account set successfully");
    }
    ...
    private String statementForAccount(Account a) {
       ...
       //Translate to pretty account type
                if(a instanceof  Checking_Account) {
                    s += "Checking com.abc.Account\n";
                }else if(a instanceof  Savings_Account) {
                    s += "Savings com.abc.Account\n";
                }else {
                    s += "Maxi Savings com.abc.Account\n";
                }
...
//An assumption has been made that each customer should have a unique national id number
    ...
    private void chekcCustomerAge(int age) {
        if (age < 18 || age > 130 ) {
            throw new IllegalArgumentException("com.abc.Customer must be over 18 and less than 130 years old");
        }
    }
