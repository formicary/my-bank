...
public class Transaction {
     ...
     * @param amount is the amount the transaction represents.
     * @throws IllegalArgumentException if amount is null.
     */
    public Transaction(BigDecimal amount) {
    	//Ensure amount isn't null
    	if(amount == null) {
    		throw new IllegalArgumentException(Transaction.class + 
    ...
    /**
     * Constructor to create a transaction at the current time, of a given amount.
     * @param amount is the amount the transaction represents. Must be parsable by BigDecimal.
     * @throws IllegalArgumentException if amount is null, or if amount isn't parsable.
     */
    public Transaction(String amount) {
    	...
    	try {
    		...
    		throw new IllegalArgumentException(Transaction.class + 
    				"::amount must be a parsable number.");
    	}
    	TRANSACTION_DATE = DateProvider.getInstance().now();
    }
     ...
     * @return Returns the amount the transaction was for rounded down to the currency standard.
     */
     ...
     * @param value is the amount to be formatted as currency.
     * @return Returns the formatted version of value. If value is null returns blank string.
     */
