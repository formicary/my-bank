...
// A method that adds a customer to the bank's list.
    ...
    { if(customers.containsKey(customer)){
        throw new IllegalArgumentException("com.abc.Customer already exists");
    }else{
        customers.put(customer,customer.getAccounts());
    }

    }
// A method that deletes a com.abc.Customer from the bank's list.
    ...
    public String customerSummary() {
        ...
        String summary = "com.abc.Customer Summary";
        for (Customer c : keys)
