...
public class Bank {
	 ...
	 * 
	 * @param customer
	 *            is the customer you wish to add.
	 ...
	 * 
	 * @param number
	 *            Number of item the word is referring to
	 * @param word
	 *            The singular representation of the item.
	 * @return Returns pluralised version of the word if Number is more than 1, else
	 *         returns same word.
	 */
	...
	public void applyInterest() {
		// For each customer loop though all their accounts and deposit owed annual
		// interest.
		for (Customer c : CUSTOMERS) {
	...
	public void applyDailyInterest() {
		// For each customer loop though all their accounts and deposit owed daily
		// interest.
		for (Customer c : CUSTOMERS) {
			Iterator<Account> i = c.getAccountIterator();
			Account a = null;
	...
	public String toString() {
		return "Customers: " + CUSTOMERS.size() + "  Total Holdings: " + Transaction.toCurrecy(getTotalHoldings());
	}
}
