...
public class CustomerTest {
    ...
    public void testTransfer(){
        ...
        Customer yoon = new Customer("Yoon").openAccount(checkingAccount).openAccount(savingsAccount);

        checkingAccount.deposit(200.0);
        savingsAccount.deposit(200.0);
        yoon.transfer(checkingAccount, savingsAccount, 100.0);

        assertEquals("Statement for Yoon\n" +
                "\n" +
                "Checking Account\n" +
                "  deposit $200.00\n" +
                "  withdrawal $100.00\n" +
                ...
                "Total $300.00\n" +
                "\n" +
                "Total In All Accounts $400.00", yoon.getStatement());
    }
}
