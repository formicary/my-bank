...
public class BankTest {
    ...
    public void TestGetFirstCustomer_ShouldBeSame() {
        String[] customerNames = {"Bob", "Michael", "Daniel", "Kevin", "Owen"};
    ...
    public void TestGetFirstCustomer_NoCustomers_ShouldThrowException() {
        Bank bank = new Bank();
        bank.getFirstCustomer();
    }

    @Test (expected=UnsupportedOperationException.class)
    public void TestBankAddCustomer_SameCustomer_ShouldThrowException() {
        Bank bank = new Bank();
    ...
    public void TestBankAddCustomer_TwoCustomers_ShouldBeCorrect() {
        ...
        Customer natasha = new Customer("Natasha");

        bank.addCustomer(rebecca);
        bank.addCustomer(natasha);
    ...
    public void TestTotalInterestPaid_ShouldBeCorrect() {
        ...
        Account bob_checkingAccount = new Account(Account.ACCOUNT_TYPE.CHECKING);
        Account bob_savingsAccount = new Account(Account.ACCOUNT_TYPE.SAVINGS);
        Account steve_maxiSavingsAccount = new Account(Account.ACCOUNT_TYPE.MAXI_SAVINGS);
        ...
        double expectedInterest = Double.parseDouble(ReportFormatter.decimalFormatter.format(annualInterest / daysInYear * days));

        String a = bank.showPaidInterestReport();
