...
public class TransactionTest {
    ...
    public void Constructor_NegativeAmount_ShouldThrowException() {
        Transaction t = new Transaction(Account.ACCOUNT_TYPE.CHECKING, -150, true);
    }

    @Test
    public void TestConstructor_ValidArguments_ShouldReturnTransactionInstance() {
        Transaction t = new Transaction(Account.ACCOUNT_TYPE.SAVINGS, 100, false);
        assertTrue(t instanceof Transaction);
    }

    @Test (expected=IllegalArgumentException.class)
    public void TestTransactionDate_NegativeNumberOfDays_ShouldThrowException() {
        Transaction t = new Transaction(Account.ACCOUNT_TYPE.SAVINGS, 50, false);
        int daysAgo = -15;
