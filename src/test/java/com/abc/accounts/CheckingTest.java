...
public class CheckingTest {
    ...
    public void testInterestEarnedComplex() {
        ...
        double i1 = testAccount.calculateInterest(30, 1000);
        double i2 = testAccount.calculateInterest(300, 1000+i1+500);
        double i3 = testAccount.calculateInterest(35, 1000+i1+500+i2-250);
        double expectedInterest = i1+i2+i3;
        double actualInterest = testAccount.interestEarned();
        assertEquals(expectedInterest, actualInterest, DOUBLE_DELTA);
    }
}
