...
public class MaxiSavingsTest {
    private MaxiSavings testAccount;
    private final double DOUBLE_DELTA = 1e-15;
    private final long DAY_IN_MS = 1000 * 60 * 60 * 24;

    @Before
    public void init() {
        testAccount = new MaxiSavings();
    ...
    public void testCalculateInterest() {
        double expectedInterest = 48.658866579095516;
        double actualInterest = testAccount.calculateInterest(365, 1000, 0);
    ...
    public void testInterestEarnedComplex() {
        ...
        double expectedInterest = 69.06268926318388;
        double actualInterest = testAccount.interestEarned();
        assertEquals(expectedInterest, actualInterest, DOUBLE_DELTA);
    }
}
