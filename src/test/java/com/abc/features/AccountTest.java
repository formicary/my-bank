...
public class AccountTest {
    ...
    // Testing to ensure a withdrawl that is greater than the total balance does not
    // go through
    @Test
    ...
    // Testing to ensure MAXI_ACCOUNT_PLUS accounts give the correct interest of
    // 0.01% if not over 10 days
    @Test
    ...
    // Testing to ensure when latest transaction was over 10 days ago, interest rate
    // is 5%
    @Test
